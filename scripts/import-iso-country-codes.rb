# ansible-playbook -v -i hosts extensions/play_maintenance.yml -e 'ruby_script=./scripts/import-iso-country-codes.rb'
...
mkey.update_attributes!  allowed_rdf_class: type.id
